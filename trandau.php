   ...
   <div class="rong"></div>
    <div class="board">
        ...
        <div class="box">
            ...
            </div> <h3>Real Madrid </h3></div>
        <div class="mota">
            <H3>thời gian : 16/2</H3>
            <p>tỉ số: 1-0</p>
        </div>
        </div>
        <div class="rong"></div>
    ...
    <div class="board">
        ...
        <div class="box">
            ...
            </div> <h3>Man Utd </h3></div>
        <div class="mota">
            <H3>thời gian: 24/2</H3>
            <p>tỉ số: 1-1</p>
        </div>
        </div>
        <div class="rong"></div>
